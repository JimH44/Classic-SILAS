[Setup]
#define AppVersion "2.205"
#define AppBuild "1.02"
#define BookletVersion "2.56"
#define Language "Spanish"
AppName=Silas
AppVerName=Silas Version {#AppVersion} build {#AppBuild} ({#Language})
DefaultDirName={pf}\Silas-{#Language}
DefaultGroupName=Silas-{#Language}
LicenseFile=.\Silas Info.txt
OutputDir=.\Output
OutputBaseFilename=Silas-v{#AppVersion}-{#AppBuild}-Setup-{#Language}
...
; Source: .\USFM-2.05.pdf; DestDir: {app}; Flags: ignoreversion
...
Name: {userdesktop}\Frequently Asked Questions about Silas; Filename: {app}\\FAQ Silas.doc; WorkingDir: {app}; Tasks: desktopicon; Languages:
